...
const ProblemSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-32 overflow-hidden">
      ...
      >
        <div className="absolute top-1/4 right-1/4 w-64 h-64 border border-destructive/50 rounded-full" />
        <div className="absolute bottom-1/4 right-1/3 w-48 h-48 border border-destructive/30" />
      </motion.div>
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              <div className="relative p-8 bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg hover:border-destructive/50 transition-colors duration-300">
                <stat.icon className="w-8 h-8 text-destructive/70 mb-4" />
