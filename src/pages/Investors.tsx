...
import { Lock, Eye, EyeOff, ArrowLeft, ChevronDown } from 'lucide-react';
import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { toast } from 'sonner';

// Import original homepage sections for investor content
...
const Investors = () => {
  ...
  const scrollToContent = () => {
    document.getElementById('investor-content')?.scrollIntoView({ behavior: 'smooth' });
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 pb-8 text-center">
          ...
          >
            <p className="text-xs mb-2">View investor materials</p>
            <ChevronDown className="w-5 h-5 mx-auto animate-bounce" />
          </button>
        </div>
      </div>

      {/* Investor Content (migrated from old homepage) */}
      <div id="investor-content" className="bg-background">
        ...
        <footer className="relative z-10 p-6 text-center border-t border-border/50">
